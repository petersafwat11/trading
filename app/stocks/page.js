...
const page = () => {
  return (
    <div className={classes["page"]}>
      ...
      <Top title="Stocking Investment" description="Unravel the leading market strategies from professional traders and discover key insights and signals to propel your path to financial freedom!" />
      <BundlePackege />
      <SoloPackage />
      <Plans />
    </div>
